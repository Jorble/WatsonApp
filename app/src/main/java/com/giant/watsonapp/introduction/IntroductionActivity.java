...
import com.giant.watsonapp.models.IntroductionDao;
...
public class IntroductionActivity extends AppCompatActivity {
    ...
    private List<Introduction> mDatas = new ArrayList<>();
    ...
    private void beginRefreshing() {
        ...
        new Handler().postDelayed(() -> {
            IntroductionDao.queryAll(new IntroductionDao.DbCallBack() {
                @Override
                public void onSuccess(List<Introduction> datas) {
                    ...
                    if (mDatas == null || mDatas.size() == 0) {
                        ...
                        adapter = new IntroductionAdapter(mDatas);
