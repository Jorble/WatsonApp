...
public class TextWall extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private int[] colors = {
            R.color.wall_color1, R.color.wall_color2, R.color.wall_color3,
            R.color.wall_color4, R.color.wall_color5, R.color.wall_color6,
            R.color.wall_color7};
    ...
    public void setData(List<TextItem> items, final Context context) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            temp.setFrontColor(colors[random.nextInt(colors.length)]);
            items.set(i, temp);
        }
